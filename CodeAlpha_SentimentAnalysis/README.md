...
- Detect emotions using NLP techniques and lexicons.<br>
...
- Counts positive and negative words.<br>
- Classifies sentiment as positive, negative, or neutral.<br>
- Detects emotions from the given text.<br>
- Displays sentiment score and emotion result.<br>
